      ...
      <form action="/patients" method="post">
        <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
          ...
          <div className="sm:col-span-3 field">
            ...
            >
            <div className="mt-1">
              <select className="shadow-sm focus:ring-indigo-500
              focus:border-indigo-500 block w-full sm:text-sm border-gray-300
              rounded-md">
                <option></option>
              </select>
          ...
          text-gray-700"
            ...
            >
            //
            <div className="mt-1 overflow-y-scroll h-24 py-3 px-2"></div>
          </div>
          <div className="sm:col-span-3 field">
            <label
              className="block text-sm font-medium
          text-gray-700"
              >{s("Economic Status")}</label
            >
            <div className="mt-1">
              <select
                className="shadow-sm focus:ring-indigo-500
