  ...
  <div
    ...
    <div className="flex-1 flex justify-between sm:justify-end">
      <button
        ...
        className="relative inline-flex items-center px-4 py-1 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 m-2">
